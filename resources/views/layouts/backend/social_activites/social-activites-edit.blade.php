    ...
    <section class="content">
        <div class="row">
            <div id="addCat" class="card card-primary col-md-12" style="
                ...
                color: #fff;">
                    <h3 class="card-title" id="cardTitle-add">Update Social Activites</h3>
                ...
                <form role="form" id="editSocial">
                    @csrf
                    <div class="card-body" style="position: relative">
                        <input value="{{ $social->id }}" type="text" id="id" name="id" hidden>

                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="mr-sm-2" for="inlineFormCustomSelect">Title (Bangla)</label>
                                <input value="{{ optional($social)->title_bn }}" id="title_bn" name="title_bn" type="text" class="form-control"
                                    placeholder="টাইটেল লিখুন" />

                            </div>
                            <div class="form-group col-md-6">
                                <label class="mr-sm-2" for="inlineFormCustomSelect">Title (English)</label>
                                <input value="{{ optional($social)->title_en }}" id="title_en" name="title_en" type="text" class="form-control"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 offset-3">
                                ...
                                <div style="height: 200px;
                                    ...
                                    <img src="{{ asset('/images/'.optional($social)->image) }}" id="cover-img" style="height: 200px;
                                      width: 100% !important;
                        ...
                        <div class="form-group">
                            ...
                            class="form-control">{{ optional($social)->description_en }}</textarea>
                        </div>
                        <div class="form-group">
                            <label class="mr-sm-2">Description (Bangla)</label>
                            <textarea id="description_bn" name="description_bn" type="text"
                                class="form-control">{{ optional($social)->description_bn }}</textarea>
                        </div>
    ...
    for(var instanceName in CKEDITOR.instances){
      CKEDITOR.instances[instanceName].updateElement();
        ...
        $.ajax({
            ...
            method: "POST",
            data: new FormData(document.getElementById("editSocial")),
            ...
            success: function(response) {
                window.location.href='/admin/socials';
                Toast.fire({
                    icon: 'success',
