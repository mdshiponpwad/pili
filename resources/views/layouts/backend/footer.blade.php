...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright © 2020 <a href="#">AdminPanel</a>.</strong> All rights reserved.
  </footer>
...
<script src="{{ asset('backend/codemirror/xml.js') }}"></script>
<script src="{{ asset('backend/codemirror/htmlmixed.js') }}"></script>
