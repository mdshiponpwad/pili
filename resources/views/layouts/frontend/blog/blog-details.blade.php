                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="blog-details-content">
                        <div class="news-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img style="height: 400px !important;" src="{{ asset('/images/'.optional($blog)->image) }}" alt=""></figure>
                                <div class="lower-content">
                                    <h2>{{ optional($blog)->title_en }}</h2>
                                    <p>{!! htmlspecialchars_decode(optional($blog)->description_en) !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="blog-sidebar">
                        ...
                        height: 447px">
                            ...
                            <div class="post-inner">
                                ...
                                <div class="post">
                                    <figure class="post-thumb"><a href="{{ url('blog-details/'.$blog->title_en) }}"><img style="height: 100px !important;" src="{{ asset('/images/'.optional($blog)->image) }}" alt=""></a></figure>
                    ...
                    <div class="blog-details-content">
                        <div class="news-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img style="height: 400px !important;" src="{{ asset('/images/'.optional($blog)->image) }}" alt=""></figure>
                                <div class="lower-content">
                                    <h2>{{ optional($blog)->title_bn }}</h2>
                                    <p>{!! htmlspecialchars_decode(optional($blog)->description_bn) !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="blog-sidebar">
                        ...
                        height: 447px">
                            ...
                            <div class="post-inner">
                                @foreach ($blogs as $blog)
                                <div class="post">
                                    <figure class="post-thumb"><a href="{{ url('blog-details/'.$blog->title_bn) }}"><img style="height: 100px !important;" src="{{ asset('/images/'.optional($blog)->image) }}" alt=""></a></figure>
