                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="{{ url('blog-details/'.$blog->title_en) }}">
                                    <img style="height: 290px !important;" src="{{ asset('/images/'.optional($blog)->image) }}" alt=""></a></figure>
                                <div class="lower-content">
                                    <h5><a href="{{ url('blog-details/'.$blog->title_en) }}">{{ optional($blog)->title_en }}s</a></h5>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="{{ url('blog-details/'.$blog->title_bn) }}">
                                    <img style="height: 290px !important;" src="{{ asset('/images/'.optional($blog)->image) }}" alt=""></a></figure>
                                <div class="lower-content">
                                    <h5><a href="{{ url('blog-details/'.$blog->title_bn) }}">{{ optional($blog)->title_bn }}s</a></h5>

                                    <div class="link"><a href="{{ url('blog-details/'.$blog->title_bn) }}">আরও পড়ুন</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
