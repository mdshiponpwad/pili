...
@section('content')
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="{{ url('social-details/'.$social->title_en) }}">
                                <img style="height: 290px !important;" src="{{ asset('/images/'.optional($social)->image) }}" alt=""></a></figure>
                            <div class="lower-content">
                                <h5><a href="{{ url('social-details/'.$social->title_en) }}">{{ optional($social)->title_en }}s</a></h5>

                                <div class="link"><a href="{{ url('social-details/'.$social->title_en) }}">read more</a></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="page-title centred" style="background-image: url({{ asset('/assets/images/background/cta-1.jpg') }});">
        <div class="auto-container">
            <div class="content-box">
                <div class="title">
                    <h1>সামাজিক কর্মকাণ্ড</h1>
                </div>
                <ul class="bread-crumb clearfix">
                    <li><a href="{{ route('home') }}">হোম</a></li>
                    <li>সামাজিক কর্মকাণ্ড</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="{{ url('social-details/'.$social->title_bn) }}">
                                <img style="height: 290px !important;" src="{{ asset('/images/'.optional($social)->image) }}" alt=""></a></figure>
                            <div class="lower-content">
                                <h5><a href="{{ url('social-details/'.$social->title_bn) }}">{{ optional($social)->title_bn }}s</a></h5>

                                <div class="link"><a href="{{ url('social-details/'.$social->title_bn) }}">আরও পড়ুন</a></div>
                            </div>
                        </div>
                    </div>
                </div>
