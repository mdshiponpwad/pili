...
@section('content')
    ...
    <section class="page-title centred" style="background-image: url({{ asset('/assets/images/background/cta-1.jpg') }});">
        <div class="auto-container">
            <div class="content-box">
                <div class="title">
                    <h1>{{optional($page)->title_en}}</h1>
                </div>
                <ul class="bread-crumb clearfix">
                    <li><a href="{{ route('home') }}">Home</a></li>
                    <li>{{optional($page)->title_en}}</li>
                </ul>
            </div>
        </div>
    </section>
                        ...
                        <div class="news-block-one">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h2>{{optional($page)->title_en}}</h2>
                                    {!! htmlspecialchars_decode(optional($page)->description_en) !!}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="page-title centred" style="background-image: url({{ asset('/assets/images/background/cta-1.jpg') }});">
        <div class="auto-container">
            <div class="content-box">
                <div class="title">
                    <h1>{{optional($page)->title_bn}}</h1>
                </div>
                <ul class="bread-crumb clearfix">
                    <li><a href="{{ route('home') }}">হোম</a></li>
                    <li>{{optional($page)->title_bn}}</li>
                </ul>
            </div>
        </div>
    </section>
            ...
            <div class="row clearfix">
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="blog-details-content">
                        <div class="news-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img style="height: 400px !important;" src="#" alt=""></figure>
                                <div class="lower-content">
                                    <h2>{{optional($page)->title_bn}}</h2>
                                    {!! htmlspecialchars_decode(optional($page)->description_bn) !!}
                                </div>
                            </div>
                        </div>
                    </div>
