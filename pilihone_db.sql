...
--
-- Host: localhost:3306
-- Generation Time: Jun 04, 2022 at 10:38 PM
...
CREATE TABLE `banners` (
  ...
  `sub_title_bn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `carts` (
  ...
  `weight_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `weight_bn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `categories` (
  ...
  `cat_name_bn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cat_name_en` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `clients` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `left_name_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_name_bn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_desig_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_desig_bn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_company_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_company_bn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_cover` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_logo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_description_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `left_description_bn` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_name_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_name_bn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_desig_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_desig_bn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_company_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_company_bn` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_cover` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_logo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_des_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_des_bn` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `contact_us` (
  ...
  `phn_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phn_bn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `msg_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `msg_bn` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `menus` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `menu_en` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `menu_bn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug_en` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug_bn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `products` (
  ...
  `slug_en` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug_bn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_code_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_code_bn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color_bn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_en` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_bn` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `product_attributes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `product_id` bigint(20) UNSIGNED DEFAULT NULL,
  `weight_en` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `weight_bn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sku_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sku_bn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sale_price_en` decimal(8,2) DEFAULT NULL,
  `sale_price_bn` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(10, 2, '1kg', '1kg', '486109', '486109', '1090.00', '1090', '750.00', '1.00', '1.00', NULL, NULL, '2021-01-29 05:42:13', '2021-01-29 08:52:41'),
